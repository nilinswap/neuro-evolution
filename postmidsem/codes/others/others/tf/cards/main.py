...
def test_mlp(learning_rate=0.01, L1_reg=0.00, L2_reg=0.0001, n_epochs=1000,
	...
	if not os.path.isfile('/home/placements2018/forgit/neuro-evolution/05/state/tf/cards/model.ckpt.meta'):
		...
		with tf.Session() as sess:
			...
			save_path = savo.save(sess, "/home/placements2018/forgit/neuro-evolution/05/state/tf/cards/model.ckpt")
