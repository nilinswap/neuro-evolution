...
def test_mlp(learning_rate=0.01, L1_reg=0.00, L2_reg=0.0001, n_epochs=1000,
	...
	#printfun=theano.function([],rest_set[1])
	#print(type(rest_set[1]))
	millis=lis[2]#lis

	
	par_size=int(rest_set[0].get_value().shape[0]/n_par)
	...
	for n_hid in range(0,n_hidden,10):
		...
		classifier= MLP(
		    ...
		    n_in=15,
		    n_hidden=n_hid,
		    n_out=1			#this was important, I tried taking 1 gave fatal results, decided to fix this later.
		)
		...
		test_model = theano.function(
		    ...
		    outputs=classifier.newerrors(y),
		    givens={
		    	x:test_x_to_be,
		    	y:test_y_to_be
		    },
